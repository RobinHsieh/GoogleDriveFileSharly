...
1. 理由具體性（+0 ~ +6 分）
   - +0 分：理由過於空泛無具體原因，並且字數過於精簡（例如：「沒看完」、「臨時有事」、「沒時間」）。
   - +3 分：理由仍較為籠統，但至少資訊量足夠（例如：「因為工作忙錄」、「有事耽擱了，事後只看完一半」、「家裡有事，忙完已經到期了」、「有不懂的地方，需要再複習一次」）。
...
3. 合理性（-3 ~ +2 分）
   ...
   - 0 分：理由籠統，但沒有到太精簡（例如：「臨時有事」、「臨時有狀況」）。
   - +2 分：理由合理且具有說服力，能讓人理解與同理（例如：「因為生病無法觀看」、「因為工作加班耽誤補課」、「家庭緊急狀況」、「沒收到上週的連結」、「沒有收到」、「有不懂的地方」）。
   ※ 分析時需判斷該理由是否合理。
